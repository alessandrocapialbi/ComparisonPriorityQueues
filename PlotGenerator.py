...
class PlotGenerator:
    ...
    def measure_insertion_time(self, pq, n, timeCalculation, randomRange=1000):
    ...
    def measure_extraction_time_3(self, pq, n, window_size=100):
        if (isinstance(pq, HeapPriorityQueue)):
            name = "Priority Queue"
        elif (isinstance(pq, UnsortedLinkedListPriorityQueue)):
            name = "Unsorted List"
        ...
        if i >= window_size:
            moving_averages[i + 1] = sum(times[(i + 1) - window_size:(i + 1)]) / window_size
